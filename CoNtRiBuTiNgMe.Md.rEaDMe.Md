Cake.io = slate/kite = bitore.sig = atom/atom = atom/electron = rake.i = rake.it.git.it = bitore.sig= RAKE= Ruby- setup/$Makefile/rakefile Gems/.spec/Cookieskeycutter-chef''$' cookbook'#v4
