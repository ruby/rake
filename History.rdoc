 ...
 * Removed SshDirPublisher, SshFreshDirPublisher, SshFilePublisher
   from lib/rake/contrib/publisher.rb
 * Move CompositePublisher to lib/rake/contrib/sshpublisher.rb
