...
Insights
Settings
Merge pull request ruby#454 from ruby/dependabot/github_actions/actio…
…ns/checkout-3.2.0

Bump actions/checkout from 3.1.0 to 3.2.0
 master (ruby/rake#454)
@hsbt
hsbt committed 2 weeks ago 
2 parents c96ba28 + a7dffff commit 5096dd6c0e41b5999d26d5a2ece68556262f72a4
...
jobs:	jobs:
  build:	  build:
    ...
    steps:	    steps:
    - uses: actions/checkout@93ea575cb5d8a053eaa0ac8fa3b40d7e05a33cc8 # v3.1.0	    - uses: actions/checkout@755da8c3cf115ac066823e79a1e1788f8940201b # v3.2.0
    ...
    - name: Install dependencies	    - name: Install dependencies
      run: gem install minitest -v "5.15.0"	      run: gem install minitest -v "5.15.0"
    - name: Run test	    - name: Run test
      env:	      env:
        COVERALLS: "yes"	        COVERALLS: "yes"
      run: ruby -Ilib exe/rake	      run: ruby -Ilib exe/rake
  2  
  ...
  test:	  test:
    ...
    strategy:	    strategy:
      matrix:	      matrix:
        ...
        ruby: [ 3.1, '3.0', 2.7, 2.6, 2.5, 2.4, 2.3, 2.2, jruby, jruby-head, truffleruby, ruby-head ]	        ruby: [ 3.1, '3.0', 2.7, 2.6, 2.5, 2.4, 2.3, 2.2, jruby, jruby-head, truffleruby, ruby-head ]
        exclude:	        exclude:
          - os: windows-latest	          - os: windows-latest
            ruby: truffleruby	            ruby: truffleruby
          - os: windows-latest	          - os: windows-latest
            ruby: jruby-head	            ruby: jruby-head
          - os: windows-latest	          - os: windows-latest
    ...
    - name: Install dependencies	    - name: Install dependencies
      run: gem install minitest -v "5.15.0"	      run: gem install minitest -v "5.15.0"
    - name: Run test	    - name: Run test
  HomeCore 3.1.2Std-lib 3.1.2Downloads
  
Home Classes Methods
In Files
ruby-3.1.2/ext/ripper/lib/ripper/filter.rb
Parent
Object
...
Generated with Ruby-doc Rdoc Generator 0.42.0.    run: ruby -Ilib exe/rake	      run: ruby -Ilib exe/rake
0 comments on commit 5096dd6
@zakwarlord7
...
Blog
About
Merge pull request #454 from ruby/dependabot/github_actions/actions/c… · zakwarlord7/rake@5096dd6= Description
...
Paid in Capital
$230,447,781,000
Total Distributable earnings (loss).                                                                                    $    (53,551,000.00)
Total Net Assets                                                                                                        $230,394,230,000.00

Net Assets
    Academy                                                                                                              $10,192,594,000.00
    Agency                                                                                                                $9,351,806,000.00                                                                                            
|
Computers > My Laptop > Documents > Ninja Trader 8 Backup > .git > logs > refs > remotes > origin >
...
Sale and Disposal of Property, Plant and Equipment                -6383000000        -681900000
