...
are some conventions that are used in a Rakefile that a little unusual
in a typical Ruby program.  Since a Rakefile is tailored to specifying
tasks and actions, the idioms used in a Rakefile are designed to
support that.
...
defined for it.  But the rakefile has a rule that look like this ...
  ...
  rule '.o' => ['.c'] do |t|
    Sys.run "cc #{t.source} -c -o #{t.name}"
  end
